...
if(isset($_POST['update'])){
   ...
   // Sanitizing name with FILTER_SANITIZE_FULL_SPECIAL_CHARS
   $name = $_POST['name'];
   $name = filter_var($name, FILTER_SANITIZE_FULL_SPECIAL_CHARS); 

   // Sanitizing price (using FILTER_SANITIZE_NUMBER_FLOAT for proper sanitization of numbers)
   $price = $_POST['price'];
   $price = filter_var($price, FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION); 

   // Sanitizing details with FILTER_SANITIZE_FULL_SPECIAL_CHARS
