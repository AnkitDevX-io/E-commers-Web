<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="mailto:harshchy143@gmail.com"><i class="fas fa-envelope"></i> info@vkart.com</a>
         <a href="https://www.google.com/myplace"><i class="fas fa-map-marker-alt"></i> Amravati, India </a>
      </div>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>VITTHAL MORE</span> | all rights reserved!</div>
